...
!(function (t, e) {
  ...
  function Ba(t, e, r, i) {
    return (
      t._startAt &&
      (I ? t._startAt.revert(ht) : (t.vars.immediateRender && !t.vars.autoRevert) || t._startAt.render(e, !0, i))
    );
  }
  function Da(t) {
  ...
  function Ia(t, e) {
    ...
    if (
      ((e._time || (e._initted && !e._dur)) &&
        ((r = Fa(t.rawTime(), e)), (!e._dur || xt(0, e.totalDuration(), r) - e._tTime > q) && e.render(r, !0)),
  ...
  function La(t, e, r, i) {
    return (
      jt(t, e),
      t._initted
        ? !r && t._pt && ((t._dur && !1 !== t.vars.lazy) || (!t._dur && t.vars.lazy)) && f !== zt.frame
    ...
    for (var r, i = t._first; i; )
      i instanceof Qt
        ...
        : !i.vars.yoyoEase ||
          (i._yoyo && i._repeat) ||
          i._yoyo === e ||
          (i.timeline ? Ob(i.timeline, e) : ((r = i._ease), (i._ease = i._yEase), (i._yEase = r), (i._yoyo = e))),
        (i = i._next);
  }
  function Qb(t, e, r, i) {
    void 0 === r &&
  ...
  var Xt,
    ...
    Vt =
      ...
      (Xt.totalDuration = function totalDuration(t) {
        return arguments.length
          ? ((this._dirty = 0),
            Qa(this, this._repeat < 0 ? t : (t - this._repeat * this._rDelay) / (this._repeat + 1)))
          : this._tDur;
      }),
      ...
      (Xt.time = function time(t, e) {
        return arguments.length
          ? this.totalTime(
              Math.min(this.totalDuration(), t + Da(this)) % (this._dur + this._rDelay) || (t ? this._dur : 0),
              e
            )
          : this._time;
      }),
      ...
      (Xt.progress = function progress(t, e) {
        return arguments.length
          ? this.totalTime(this.duration() * (!this._yoyo || 1 & this.iteration() ? t : 1 - t) + Da(this), e)
          : this.duration()
      ...
      (Xt.eventCallback = function eventCallback(t, e, r) {
        ...
        return 1 < arguments.length
          ? (e ? ((i[t] = e), r && (i[t + "Params"] = r), "onUpdate" === t && (this._onUpdate = e)) : delete i[t],
            this)
          : i[t];
      }),
  ...
  var Qt = (function (i) {
    ...
    return (
      ...
      (e.staggerFrom = function staggerFrom(t, e, r, i, n, a, s) {
        return (
          (r.runBackwards = 1), (ua(r).immediateRender = w(r.immediateRender)), this.staggerTo(t, e, r, i, n, a, s)
        );
      }),
      (e.staggerFromTo = function staggerFromTo(t, e, r, i, n, a, s, o) {
        return (
          (i.startAt = r), (ua(i).immediateRender = w(i.immediateRender)), this.staggerTo(t, e, i, n, a, s, o)
        );
      }),
      ...
      (e.totalTime = function totalTime(t, e) {
        return arguments.length
          ? ((this._forcing = 1),
            !this._dp &&
              this._ts &&
              (this._start = ia(zt.time - (0 < this._ts ? t / this._ts : (this.totalDuration() - t) / -this._ts))),
        ...
        (u = new dt[t]()).init(
          ...
          u.rawVars
            ...
            : (function _processVars(t, e, i, n, a) {
                if ((s(t) && (t = Gt(t, a, e, i, n)), !v(t) || (t.style && t.nodeType) || K(t) || Z(t)))
    ...
    qt = function _addPropTween(t, e, i, n, a, o, u, h, l, f) {
      ...
      if (
        ...
        return isNaN(p * n) || "" === n
          ...
          : ((c = new me(this._pt, t, e, +p || 0, n - (p || 0), "boolean" == typeof d ? ne : re, 0, _)),
            l && (c.fp = l),
    ...
    jt = function _initTween(t, e) {
      ...
      if (
        ...
        if (
          ...
          (r = ta(_, lt)),
          S && (e < 0 && M && v && !P ? S.render(-1, !0) : S.revert(M && C ? ht : ut), (S._lazy = 0)),
          g)
        ) {
          if (
            (ya(
          ...
          if (
            (e && (v = !1),
            (n = pa(
              { overwrite: !1, data: "isFromStart", lazy: v && w(y), immediateRender: v, stagger: 0, parent: D },
              r
            )),
            d && (n[h.prop] = d),
        ...
        for (t._pt = t._ptCache = 0, y = (C && w(y)) || (y && !C), i = 0; i < A.length; i++) {
          ...
          t._op && t._op[i] && t.kill(s, t._op[i]),
            R && t._pt && ((Ut = t), B.killTweensOf(s, f, t.globalTime(e)), (p = !t.parent), (Ut = 0)),
            t._pt && y && (ct[u.id] = 1);
        }
          ...
          if (K(x))
            ...
            for (l in u)
              for (
                ...
                ((D = { ease: (A = S[o]).e, duration: ((A.t - (o ? S[o - 1].t : 0)) / 100) * _ })[l] = A.v),
                  s.to(C, D, z),
                  (z += D.duration);
          ...
          !(function _renderZeroDurationTween(t, e, r, i) {
            ...
            if (
              (h &&
                ...
                (a = yt(l, h)),
                t._yoyo && 1 & a && (u = 1 - u),
                a !== yt(t._tTime, h) && ((o = 1 - u), t.vars.repeatRefresh && t._initted && t.invalidate())),
              ...
              e < 0 && Ba(t, e, 0, !0),
                ...
                (e >= t._tDur || e < 0) &&
                  t.ratio === u &&
                  (u && ya(t, 1),
                  r || I || (Pt(t, u ? "onComplete" : "onReverseComplete", !0), t._prom && t._prom()));
      ...
      (e.kill = function kill(t, e) {
        ...
        for (
          ...
          if (~c.indexOf(f[l]))
            ...
            o))
              (h = a && a[u]) && (("kill" in h.d && !0 !== h.d.kill(u)) || xa(this, h, "_pt"), delete a[u]),
                "all" !== s && (s[u] = 1);
  ...
  var Se,
    ...
    _r = function _get(t, e, r, i) {
      ...
      return (
        ...
        er[e] && "transform" !== e
          ? ((n = Tr(t, i)),
            (n = "transformOrigin" !== e ? n[e] : n.svg ? n.origin : br(Md(t, lr)) + " " + n.zOrigin + "px"))
          : ((n = t.style[e]) && "auto" !== n && !i && !~(n + "").indexOf("calc(")) ||
            (n = (gr[e] && gr[e](t, e, r)) || Md(t, e) || fa(t, e) || ("opacity" === e ? 1 : 0)),
    ...
    kr = function _renderCSSTransforms(t, e) {
      ...
      _ !== Mr && (y += "perspective(" + _ + Or),
        ...
        (!T && a === Mr && s === Mr && o === Mr) ||
          (y +=
            o !== Mr || T ? "translate3d(" + a + ", " + s + ", " + o + ") " : "translate(" + a + ", " + s + Or),
        u !== xr && (y += "rotate(" + u + Or),
        h !== xr && (y += "rotateY(" + h + Or),
        l !== xr && (y += "rotateX(" + l + Or),
          ...
          if ("autoRound" !== c && ((o = e[c]), !dt[c] || !$b(c, e, i, n, t, a)))
            if (
              ...
              if (m || ((u || 0 === u) && (h || 0 === h) && !or.test(o) && c in x))
                (u = u || 0),
                  (d = (s + "").substr((h + "").length)) !== (p = Xa(o) || (c in V.units ? V.units[c] : d)) &&
                    (h = Yd(t, c, s, p)),
                  (this._pt = new me(
                    this._pt,
                    m ? v : x,
